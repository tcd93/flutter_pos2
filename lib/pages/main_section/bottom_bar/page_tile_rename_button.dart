...
class RenameButton extends ConsumerWidget {
  ...
  static void _rename(BuildContext context, int pageID, String currentText) {
    // dismiss current bottom sheet
    Navigator.of(context).pop();
    // change dish image type to url
    if (currentText.isNotEmpty)
      ProviderScope.containerOf(context)
          .read(pageNameProvider(pageID).notifier)
          .set(currentText);
  }
        ...
        return Padding(
          ...
          child: ListTile(
            title: TextField(
              ...
              onEditingComplete: () {
                _rename(context, pageID, titleController.text);
              },
            ),
