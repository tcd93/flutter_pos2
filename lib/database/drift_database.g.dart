...
class DefaultDiscount extends Table
    with TableInfo<DefaultDiscount, DefaultDiscountData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  DefaultDiscount(this.attachedDatabase, [this._alias]);
  ...
  @override
  List<GeneratedColumn> get $columns => [rate];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'default_discount';
  @override
  VerificationContext validateIntegrity(
      Insertable<DefaultDiscountData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  DefaultDiscountData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return DefaultDiscountData(
  ...
  @override
  DefaultDiscount createAlias(String alias) {
    return DefaultDiscount(attachedDatabase, alias);
  }
...
class DefaultDiscountData extends DataClass
    implements Insertable<DefaultDiscountData> {
  final double rate;
  const DefaultDiscountData({required this.rate});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  DefaultDiscountCompanion toCompanion(bool nullToAbsent) {
    return DefaultDiscountCompanion(
      rate: Value(rate),
    );
  }

  factory DefaultDiscountData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return DefaultDiscountData(
  ...
  DefaultDiscountData copyWith({double? rate}) => DefaultDiscountData(
        rate: rate ?? this.rate,
      );
  @override
  String toString() {
    return (StringBuffer('DefaultDiscountData(')
          ..write('rate: $rate')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is DefaultDiscountData && other.rate == this.rate);
}

class DefaultDiscountCompanion extends UpdateCompanion<DefaultDiscountData> {
  final Value<double> rate;
  final Value<int> rowid;
  const DefaultDiscountCompanion({
    this.rate = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  DefaultDiscountCompanion.insert({
    this.rate = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  static Insertable<DefaultDiscountData> custom({
  ...
  DefaultDiscountCompanion copyWith({Value<double>? rate, Value<int>? rowid}) {
    return DefaultDiscountCompanion(
      rate: rate ?? this.rate,
  ...
  @override
  String toString() {
    return (StringBuffer('DefaultDiscountCompanion(')
          ..write('rate: $rate, ')
          ..write('rowid: $rowid')
          ..write(')'))
        .toString();
...
class Transactions extends Table with TableInfo<Transactions, Transaction> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, cardID, date, time, price, discountRate, note];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  factory Transaction.fromJson(Map<String, dynamic> json,
    ...
    return Transaction(
      ...
      price: serializer.fromJson<double?>(json['price']),
      discountRate: serializer.fromJson<double?>(json['discount_rate']),
      note: serializer.fromJson<String?>(json['note']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'price': serializer.toJson<double?>(price),
      'discount_rate': serializer.toJson<double?>(discountRate),
      'note': serializer.toJson<String?>(note),
    };
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, cardID, date, time, price, discountRate, note);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
abstract class _$DriftDB extends GeneratedDatabase {
  ...
  late final DefaultDiscount defaultDiscount = DefaultDiscount(this);
  ...
  Selectable<GetServingLinesResult> getServingLines(int cardID) {
    return customSelect(
        'SELECT name, price, portion FROM servings AS s INNER JOIN dishes AS d ON s.dishID = d.id WHERE s.cardID = ?1',
        variables: [
          Variable<int>(cardID)
        ],
        readsFrom: {
          dishes,
          servings,
        }).map((QueryRow row) => GetServingLinesResult(
          name: row.read<String>('name'),
          price: row.read<double>('price'),
          portion: row.read<int>('portion'),
        ));
  }
...
class GetServingLinesResult {
  final String name;
  final double price;
  final int portion;
  GetServingLinesResult({
    required this.name,
    required this.price,
